            ...
            <div className="w-full">
                ...
                <div className="w-full mx-auto">
                    ...
                    <div className="text-center pt-[50px]">
                        <button className=' bg-gradient-to-r from-[#FFBF5E] bg-primary py-2 px-8 uppercase  text-white rounded hover:bg-[#dea029]'><a href="https://academy.mindchain.info/"></a>More Articles</button>a></button>
                    </div>
                </div>

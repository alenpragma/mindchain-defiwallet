               ...
               <div className="flex flex-col md:flex-row gap-y-[20px] md:gap-y-0 justify-between items-center">
                <div className="w-full md:w-[32%] ">
                      <ul className='flex flex-col md:flex-row gap-[20px]'>
                        <li className='relative before:absolute before:w-[25%]  md:before:w-[100%] before:h-[2px] before:bg-primary before:opacity-0 before:hover:opacity-100 before:content-[""] before:bottom-[-50%] before:left-[0%] hover:before:left-[50%] before:translate-x-[-50%] before:translate-y-[-50%] before:z-10 hover:before:transition-all hover:opacity-100 hover:before:ease-in-out hover:before:duration-700'><a href="https://mindchain.info">MIND Ecosystem</a></li>
                        <li className='relative before:absolute before:w-[25%]  md:before:w-[100%] before:h-[2px] before:bg-primary before:opacity-0 before:hover:opacity-100 before:content-[""] before:bottom-[-50%] before:left-[0%] hover:before:left-[50%] before:translate-x-[-50%] before:translate-y-[-50%] before:z-10 hover:before:transition-all hover:opacity-100 hover:before:ease-in-out hover:before:duration-700'><a href="https://mainnet.mindscan.info/">Mainnet Explorer</a></li>
                        <li className='relative before:absolute before:w-[25%]  md:before:w-[100%] before:h-[2px] before:bg-primary before:opacity-0 before:hover:opacity-100 before:content-[""] before:bottom-[-50%] before:left-[0%] hover:before:left-[50%] before:translate-x-[-50%] before:translate-y-[-50%] before:z-10 hover:before:transition-all hover:opacity-100 hover:before:ease-in-out hover:before:duration-700'><a href="https://pay.mindchain.info">MindPay</a></li>
                      </ul>
                  </div>
                ...
                <div className="w-full md:w-[32%]">
                      <ul className='flex flex-col md:flex-row gap-y-[20px] md:gap-y-0 md:gap-x-[50px]'>
                        <li className='relative before:absolute md:before:w-[100%] before:w-[25%] before:h-[2px] before:bg-primary before:opacity-0 before:hover:opacity-100 before:content-[""] before:bottom-[-50%] before:left-[0%] hover:before:left-[50%] before:translate-x-[-50%] before:translate-y-[-50%] before:z-10 hover:before:transition-all hover:opacity-100 hover:before:ease-in-out hover:before:duration-700'><a href="http://mindchainwallet.com/register">Register</a></li>
                        <li className='relative before:absolute md:before:w-[100%] before:w-[25%] before:h-[2px] before:bg-primary before:opacity-0 before:hover:opacity-100 before:content-[""] before:bottom-[-50%] before:left-[0%] hover:before:left-[50%] before:translate-x-[-50%] before:translate-y-[-50%] before:z-10 hover:before:transition-all hover:opacity-100 hover:before:ease-in-out hover:before:duration-700'><a href="https://www.wallet.mindchain.info/">Wallet</a></li>
                        <li className='relative before:absolute md:before:w-[100%] before:w-[25%] before:h-[2px] before:bg-primary before:opacity-0 before:hover:opacity-100 before:content-[""] before:bottom-[-50%] before:left-[0%] hover:before:left-[50%] before:translate-x-[-50%] before:translate-y-[-50%] before:z-10 hover:before:transition-all hover:opacity-100 hover:before:ease-in-out hover:before:duration-700'><a href="https://t.me/mindchainMIND">Telegram</a></li>
                      </ul>
                  </div>
               </div>
               <div className="">

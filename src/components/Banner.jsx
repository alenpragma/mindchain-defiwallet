            ...
            <div className="flex justify-between items-center pt-[170px] pb-[90px] w-full animate-fade-down animate-once">
                ...
                <div className="w-full md:w-[35%] text-center md:text-start ">
                    ...
                    <div className="flex flex-col md:flex-row gap-3 md:w-full mx-auto md:mx-0">
                        <a className=' bg-gradient-to-r from-[#FFBF5E] bg-primary py-[5px] lg:py-4 md:px-7 uppercase rounded hover:bg-[#dea029] flex-none w-[200px] lg:w-[50%] mx-auto text-center' href="https://my.mindchainwallet.com/register">Get Started</a>
                        <a className=' bg-gradient-to-r from-[#FFBF5E] bg-primary py-[5px] lg:py-4 md:px-11 uppercase rounded hover:bg-[#dea029] flex-none w-[200px] lg:w-[50%] mx-auto text-center' href="https://my.mindchainwallet.com/login">Login</a>
                    </div>
                </div>
